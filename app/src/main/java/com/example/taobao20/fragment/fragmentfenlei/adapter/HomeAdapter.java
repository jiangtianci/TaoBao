...
public class HomeAdapter extends BaseAdapter {
    ...
    private List<FenleiBean.DataBean> foodDatas;

    public HomeAdapter(Context context, List<FenleiBean.DataBean> foodDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        FenleiBean.DataBean dataBean = foodDatas.get(position);
        List<FenleiBean.DataBean.DataListBean> dataList = dataBean.getDataList();
        ViewHold viewHold = null;
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.fenlei_item_home, null);
